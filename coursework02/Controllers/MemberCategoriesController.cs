...
namespace coursework02.Controllers
{
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,TotalLoan")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,TotalLoan")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
